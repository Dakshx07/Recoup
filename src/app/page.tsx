        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 max-w-3xl mx-auto mt-14 pt-8 border-t border-neutral-200/80 text-left">
            <div className="bg-white/80 backdrop-blur-xs p-3.5 rounded-lg border border-neutral-200/70 shadow-2xs">
              <p className="text-[11px] font-medium text-neutral-500 uppercase tracking-wider">Recovery Rate</p>
              <p className="text-xl font-bold text-neutral-900 font-mono mt-0.5">40.12%</p>
              <p className="text-[11px] text-green-700 font-medium">₹50.06L recovered book</p>
            </div>
            <div className="bg-white/80 backdrop-blur-xs p-3.5 rounded-lg border border-neutral-200/70 shadow-2xs">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            <div className="bg-white rounded-xl border border-neutral-200 p-5 shadow-xs">
              <p className="text-xs font-medium text-neutral-500 uppercase tracking-wider">Invoiced Book</p>
            ...
            <div className="bg-white rounded-xl border border-neutral-200 p-5 shadow-xs">
              <p className="text-xs font-medium text-neutral-500 uppercase tracking-wider">Capital Recovered</p>
            ...
            <div className="bg-white rounded-xl border border-neutral-200 p-5 shadow-xs">
              <p className="text-xs font-medium text-neutral-500 uppercase tracking-wider">Recovery Rate</p>
            ...
            <div className="bg-white rounded-xl border border-neutral-200 p-5 shadow-xs">
              <p className="text-xs font-medium text-neutral-500 uppercase tracking-wider">Freeze Adherence</p>
          ...
          <div className="bg-white rounded-xl border border-neutral-200 p-6 shadow-xs space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-neutral-100 pb-3">
              ...
              <span className="inline-flex px-2 py-0.5 rounded text-[11px] font-mono font-medium bg-neutral-100 text-neutral-700">
                N = 200 Invoices
              </span>
            </div>
